...
<Image src='/static/img/winnebago-micro-minnie/winnie-delivery.jpg' alt='New trailer setup on our driveway' />
...
<ImageWithCaption src='/static/img/winnebago-micro-minnie/generator.jpg' alt='Generator in rear storage compartment'>
...
<div className='image-half'>
  <ImageWithCaption
    src='/static/img/winnebago-micro-minnie/winnie-first-trip.jpg'
    alt='Prepared to depart for our inaugural trip'>
    Ready for our maiden voyage!
  </ImageWithCaption>
  <ImageWithCaption
    src='/static/img/winnebago-micro-minnie/winnie-falcon.jpg'
    alt='Camper at Falcon Lake Beach Campground'>
...
<Image
  src='/static/img/winnebago-micro-minnie/winnie-inverter-plan.jpg'
...
<ImageWithCaption
  src='/static/img/winnebago-micro-minnie/winnie-shore-power.jpg'
...
<Image
  src='/static/img/winnebago-micro-minnie/inverter-final-install.jpg'
...
<Image
  src='/static/img/winnebago-micro-minnie/soft-start-install.jpg'
...
<div className='image-half'>
  <ImageWithCaption
    src='/static/img/winnebago-micro-minnie/soft-start-status.png'
    alt='Screenshot of Easy Start app status'>
    The Easy Start app shows the current voltage and starting voltage of the A/C
  </ImageWithCaption>
  <ImageWithCaption src='/static/img/winnebago-micro-minnie/battery-status.png' alt='Screenshot of Renogy app'>
...
<Image src='/static/img/winnebago-micro-minnie/irvwpc-install.jpg' alt='The IRVWPC installed' />
